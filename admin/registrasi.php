	...
	<?php 
		...
		<tr>
			...
			<td><a class="btn teal modal-trigger" href="#regis_edit?nis=<?php echo $r['nis'] ?>">Edit</a> <a onclick="return confirm('Anda Yakin Ingin Menghapus Y/N')" class="btn red" href="index.php?p=regis_hapus&nis=<?php echo $r['nis'] ?>">Hapus</a></td>
